...
\begin{equation}
Y_i = \beta_0 + \beta_1 X_1 + \beta_2 X_2 + \beta_3 X_3 + \beta_3 X_3 + \epsilon_i
\end{equation}

In this model, $Y_i$ is the budget amount and $\beta_0$ is the intercept or the predicted value when all other variables are zero. $X_1$ is whether the expense if for a command, $X_2$ is the organizational entity, $X_3$ is whether the expense is a salary, and $X_4$ is the feature category.
